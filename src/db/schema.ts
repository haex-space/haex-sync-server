...
export const vaultKeys = pgTable(
  "vault_keys",
  {
    ...
    ephemeralPublicKey: text("ephemeral_public_key").notNull(), // X25519 SPKI ephemeral public key for vault name decryption
    ...
    vaultNameSalt: text("vault_name_salt").notNull(), // HKDF salt for vault name encryption (Ed25519→X25519 ECDH)
